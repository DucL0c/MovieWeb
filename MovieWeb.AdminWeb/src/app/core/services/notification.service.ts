...
export class NotificationService {
  ...
  constructor(private translateService: TranslateService) {
    ...
    //   .get('button.confirm')
    //   .subscribe((data) => (btnOklabel = data));
    // alertify.defaults.glossary.ok = btnOklabel;
    // let btnCancellabel = '';
    // this.translateService
    //   .get('button.cancel')
    //   .subscribe((data) => (btnCancellabel = data));
    // alertify.defaults.glossary.cancel = btnCancellabel;
    // let notificationTitle = '';
    // this.translateService
    //   .get('messageSystem.notification')
    //   .subscribe((data) => (notificationTitle = data));
