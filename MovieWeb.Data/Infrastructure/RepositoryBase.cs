...
namespace MovieWeb.Data.Infrastructure
{
    public class RepositoryBase<T> : IRepository<T> where T : class
    {
        private MovieContext dataContext;

        protected RepositoryBase(MovieContext dbContext)
        {
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public async Task<IQueryable<T>> GetAllAsync(Expression<Func<T, bool>> predicate, string[] includes)
        {
